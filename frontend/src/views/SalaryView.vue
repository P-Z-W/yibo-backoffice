...
<template>
  <div class="page-heading"><div><h1>员工工资</h1><p>工资管理能力已完整迁入新数据库。</p></div><div class="actions"><ElDatePicker v-model="month" type="month" value-format="YYYY-MM" format="YYYY年MM月" :clearable="false" /><ElButton tag="a" :href="`/api/v1/salary/export/xlsx?month=${month}`" :icon="Download">导出</ElButton><ElButton type="primary" :icon="Plus" @click="openAdd">新增记录</ElButton></div></div>
